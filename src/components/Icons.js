// Open .SVG files using text editor and paste on the left side at https://react-svgr.com/
// Then copy the JSX output to here
...
export const GoogleScholarIcon = ({ className, ...rest }) => (
    ...
    >
        ...
        />
        <path
            d="M35 16.592v-3.878L37 11H27l.917 1.833h-2.265s-6.557.167-6.557 5.915c0 5.752 5.732 5.088 5.732 5.088v1.453c0 .594.77.391.864 1.583-.388 0-7.964-.208-7.964 4.998s6.679 4.959 6.679 4.959 7.722.365 7.722-6.104c0-3.871-4.405-5.121-4.405-6.686 0-1.563 3.319-2.012 3.319-5.684 0-.823-.028-1.524-.149-2.12L34 13.571v3.02c-.581.207-1 .756-1 1.408v4.5a1.5 1.5 0 1 0 3 0V18c0-.652-.419-1.201-1-1.408zm-4.953 14.577c.131 2.024-1.929 3.811-4.603 3.998-2.671.188-4.946-1.295-5.077-3.316-.133-2.016 1.927-3.805 4.6-3.996 2.674-.188 4.947 1.297 5.08 3.314zm-3.938-8.716c-1.592.451-3.375-1.062-3.982-3.367-.604-2.312.195-4.543 1.786-4.992 1.593-.453 3.374 1.059 3.981 3.367.605 2.309-.192 4.543-1.785 4.992z"
            style={{
                fill: "#1565c0",
            }}
        />
        <path
            d="M34 16.592V12c0-.051-.015-.097-.029-.143L35 11H21l-9 8h5.383c.174 5.466 5.715 4.836 5.715 4.836v1.453c0 .594.771.391.865 1.583-.388 0-7.964-.208-7.964 4.998s6.679 4.959 6.679 4.959 7.721.365 7.721-6.104c0-3.871-4.404-5.121-4.404-6.686 0-1.563 3.318-2.012 3.318-5.684 0-.971-.047-1.763-.232-2.422L33 12.667v3.925c-.581.207-1 .756-1 1.408v4.5a1.5 1.5 0 1 0 3 0V18c0-.652-.419-1.201-1-1.408zm-5.681 14.577c.131 2.024-1.928 3.811-4.602 3.998-2.671.188-4.946-1.295-5.077-3.316-.133-2.016 1.927-3.805 4.599-3.996 2.675-.188 4.948 1.297 5.08 3.314zm-3.939-8.716c-1.591.451-3.373-1.062-3.981-3.367-.604-2.312.194-4.543 1.785-4.992 1.593-.453 3.374 1.059 3.982 3.367.604 2.309-.193 4.543-1.786 4.992z"
            style={{
                fill: "#e8eaf6",
            }}
        />
